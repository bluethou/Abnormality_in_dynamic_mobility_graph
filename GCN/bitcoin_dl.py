...
class bitcoin_dataset():
    def __init__(self,args):
        ...
        print("self ecols Weight", self.ecols.Weight)
        #build edge data structure
        edges = self.load_edges(args.bitcoin_args)
############ boot straping #################
#        print("edge args", (edges[0]))
#        rand_rows = torch.randperm(edges.shape[0])[:300]
#        random_sample = edges[rand_rows,:]
#        sampled_values = edges[torch.randperm(edges.shape[0])[300]]
#        indice = random.sample(range(edges.shape[0]), 300)
#        indice = torch.tensor(indice)
#        sampled_values = edges[indice]
#        edges = random_sample
#        print("sampled edges ", (edges[0]))
############# boot strapping ################
        edges = self.make_contigous_node_ids(edges)
#print("edge make contigous node ids", edges)
        ...
        print("edges cl neg and pos", edges)
